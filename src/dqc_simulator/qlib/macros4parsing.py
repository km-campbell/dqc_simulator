...
def swap_macro(parent_arg1, parent_arg2):
    ...
    subgate1 = {**common_entries, "args": [parent_arg1, parent_arg2]}
    subgate2 = {**common_entries, "args": [parent_arg2, parent_arg1]}
...
def crx_macro(lambda_var, a, b):
    ...
    """
    subgates = [
        {"name": "u1", "params": ["pi/2"], "args": [b]},
        {"name": "cx", "params": None, "args": [a, b]},
        {"name": "u3", "params": [minus + lambda_var + over2, "0", "0"], "args": [b]},
        {"name": "cx", "params": None, "args": [a, b]},
        {"name": "u3", "params": [lambda_var + "/2", "-pi/2", "0"], "args": [b]},
    ]
    return subgates
...
def cry_macro(lambda_var, a, b):
    ...
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [
        {"name": "ry", "params": [lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "ry", "params": [minus + lambda_var + over2], "args": [b]},
        cx_gate,
    ]
    return subgates
...
def crz_macro(lambda_var, a, b):
    ...
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [
        {"name": "rz", "params": [lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "rz", "params": [minus + lambda_var + over2], "args": [b]},
        cx_gate,
    ]
    return subgates
...
def cu1_macro(lambda_var, a, b):
    ...
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [
        {"name": "u1", "params": [lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "u1", "params": [minus + lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "u1", "params": [lambda_var + over2], "args": [b]},
    ]
    return subgates
...
def cp_macro(lambda_var, a, b):
    ...
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [
        {"name": "p", "params": [lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "p", "params": [minus + lambda_var + over2], "args": [b]},
        cx_gate,
        {"name": "p", "params": [lambda_var + over2], "args": [b]},
    ]
    return subgates
...
def cu3_macro(theta, phi, lambda_var, c, t):
    ...
    """
    subgates = [
        {"name": "u1", "params": [lpar + lambda_var + plus + phi + ")/2"], "args": [c]},
        {"name": "u1", "params": [lpar + lambda_var + "-" + phi + ")/2"], "args": [t]},
        {"name": "cx", "params": None, "args": [c, t]},
        {
            "name": "u3",
            "params": ["-" + theta + "/2", "0", "-(" + phi + "+" + lambda_var + ")/2"],
            "args": [t],
        },
        {"name": "cx", "params": None, "args": [c, t]},
        {"name": "u3", "params": [theta + "/2", phi, "0"], "args": [t]},
    ]
    return subgates
...
def cu_macro(theta, phi, lambda_var, gamma, c, t):
    ...
    subgates = [
        ...
        {"name": "cx", "params": None, "args": [c, t]},
        {"name": "u", "params": [theta + over2, phi, "0"], "args": [t]},
    ]
    return subgates
...
def rxx_macro(theta, a, b):
    ...
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [
        {"name": "u3", "params": ["pi/2", theta, "0"], "args": [a]},
        h_gate,
        cx_gate,
        {"name": "u1", "params": ["-" + theta], "args": [b]},
        cx_gate,
        h_gate,
        {"name": "u2", "params": ["-pi", "pi-" + theta], "args": [a]},
    ]
    return subgates
...
def rzz_macro(theta, a, b):
    ...
    """
    cx_gate = {"name": "cx", "params": None, "args": [a, b]}
    subgates = [cx_gate, {"name": "u1", "params": [theta], "args": [b]}, cx_gate]
    return subgates
