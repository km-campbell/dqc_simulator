...
#TO DO: deprecate this module. The functionality has been absorbed into the 
#physical layer.
...
#     """
#     def __init__(self, superprotocol, physical_layer_protocol, node=None,
#                  name=None):
...
#             self.subprotocols['physical_layer_protocol'].role = role
#             self.subprotocols[
#                 'physical_layer_protocol'].other_node_name = other_node_name
#             self.subprotocols[
