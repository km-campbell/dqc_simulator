...
def preprocess_qasm_to_compilable_bipartitioned(filepath, scheme, include_path="."):
    """
...
def preprocess_qasm_to_compilable_monolithic(filepath, include_path="."):
    ...
    dqc_circuit.replace_qreg_names(
        node_0_name="monolithic_qc", node_1_name="monolithic_qc"
    )
    ...
    node_init_cmd = [(instr.INSTR_INIT, list(range(total_num_qubits)), "monolithic_qc")]
