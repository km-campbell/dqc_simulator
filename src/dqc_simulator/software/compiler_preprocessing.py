...
from dqc_simulator.software.ast2dqc_circuit import ast2sim_readable
...
def preprocess_qasm_to_compilable_bipartitioned(filepath, scheme,
    ...
    dqc_circuit.add_scheme_to_ops(scheme)
    node_init_commands = []
    ...
    dqc_circuit.ops = node_init_commands + node_init_commands
    return dqc_circuit