...
class TestToffoliDecomp(unittest.TestCase):
    ...
    def test_both_controls_on_1_flips_target(self):
        ...
        gate_tuples = [
            (instr.INSTR_INIT, ctrl_qubit1_index, self.node_a.name),
        ...
        fidelity = qapi.fidelity(
            [ctrl_qubit1, ctrl_qubit2, target_qubit], desired_state_ket
        )
    ...
    def test_remote_gate_in_schor_error_correction_code_ctrl00(self):
        ...
        gate_tuples = [
            (instr.INSTR_INIT, [q1, q2, q3, q4, q5], self.node_a.name),
    ...
    def test_toffoli_makes_no_difference(self):
        ...
        fidelity = qapi.fidelity(
            [target_qubit, ctrl_qubit2, ctrl_qubit1], desired_state_ket
        )
        self.assertAlmostEqual(fidelity, 1.000, 3)
...
class TestStabiliserCircuits(unittest.TestCase):
    def test_z_stabiliser_measurement_with_one_measured_qubit(self):
        ...
        ancilla_to_use = 3
        stabiliser_type = "z"
        gate_tuples = stabiliser_measurement(
            qubits2check, ancilla_to_use, stabiliser_type
        )
        desired_output = [
            (instr.INSTR_CNOT, 2, "mono_qc", 3, "mono_qc"),
    ...
    def test_x_stabiliser_measurement_with_one_measured_qubit(self):
        ...
        desired_output = [
            ...
            (instr.INSTR_CNOT, qubits2check[0], "mono_qc", ancilla_to_use, "mono_qc"),
            (instr.INSTR_H, qubits2check[0], "mono_qc"),
            (instr.INSTR_MEASURE, ancilla_to_use, "mono_qc", "logging"),
        ]
        self.assertEqual(gate_tuples, desired_output)
    ...
    def test_3_qubit_z_stabiliser_measurement(self):
        ...
        desired_output = [
            (instr.INSTR_CNOT, 2, "mono_qc", 5, "mono_qc"),
