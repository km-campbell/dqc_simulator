...
class Test_sort_greedily_by_node_and_time(unittest.TestCase):
    ...
    def test_can_add_1tp_cx(self):
        ...
        updated_node_op_dict = self.compiler(partitioned_gates)
        expected_output = {
            "node_0": [[(2, "node_1", "tp", "bsm")]],
            "node_1": [[("node_0", "tp", "correct"), (instr.INSTR_CNOT, -1, 4)]],
        }
        self.assertEqual(updated_node_op_dict, expected_output)
    ...
    def test_can_add_cx_tp_safe(self):
        ...
        expected_output = {
            ...
            "node_1": [
                [("node_0", "tp", "correct"), (instr.INSTR_CNOT, -1, 4)],
                [(-1, "node_0", "tp", "bsm")],
            ],
        }
        self.assertEqual(updated_node_op_dict, expected_output)
    ...
    def test_can_handle_single_qubit_subroutine(self):
        ...
        updated_node_op_dict = self.compiler(partitioned_gates)
        expected_output = {
            "node_0": [[(instr.INSTR_INIT, 2), (instr.INSTR_MEASURE, 2, "logging")]]
        }
        self.assertEqual(updated_node_op_dict, expected_output)
    ...
    def test_distribute_ebit(self):
        ...
        updated_node_op_dict = self.compiler(partitioned_gates)
        expected_output = {
            "node_0": [[("node_1", "client", "distribute_ebit")]],
...
class Test_find_qubit_node_pairs(unittest.TestCase):
    def test_adds_single_gate(self):
        ...
        expected_output = {
            (2, "node_0", "node_1"): [
                ((instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"), 0)
            ],
            (3, "node_1", "node_0"): [
                ((instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"), 0)
            ],
    ...
    def test_adds_single_gate_from_many(self):
        ...
        expected_output = {
            (2, "node_0", "node_1"): [
                ((instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"), 1)
            ],
            (3, "node_1", "node_0"): [
                ((instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"), 1)
            ],
    ...
    def test_adds_multiple_gates(self):
        ...
        expected_output = {
            ...
            (2, "node_1", "node_0"): [
                ((instr.INSTR_CNOT, 2, "node_1", 4, "node_0", "placeholder"), 4)
            ],
            (4, "node_0", "node_1"): [
                ((instr.INSTR_CNOT, 2, "node_1", 4, "node_0", "placeholder"), 4)
            ],
...
class Test_find_node_node_pairs(unittest.TestCase):
    ...
    def test_adds_two_gates_to_same_entry(self):
        partitioned_gates = [
            (instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"),
            (instr.INSTR_CNOT, 2, "node_1", 3, "node_0", "placeholder"),
        ]
        node_node_pairs = find_node_node_pairs(partitioned_gates)
        expected_output = {
            ("node_0", "node_1"): [
                ((instr.INSTR_CNOT, 2, "node_0", 3, "node_1", "placeholder"), 0),
                ((instr.INSTR_CNOT, 2, "node_1", 3, "node_0", "placeholder"), 1),
            ]
        }
        self.assertEqual(node_node_pairs, expected_output)
    ...
    def test_adds_multiple_gates(self):
        ...
        expected_output = {
            ...
            ("node_1", "node_2"): [
                ((instr.INSTR_CNOT, 2, "node_1", 4, "node_2", "placeholder"), 4)
            ],
        }
        self.assertEqual(node_node_pairs, expected_output)
...
class Test_order_remote_gates(unittest.TestCase):
    def test_in_descending_order(self):
        ...
        expected_output = {"larger_entry": [2, 3, 4, 4], "smaller_entry": [1]}
...
class Test_find_consecutive_gate(unittest.TestCase):
    def test_realises_autocomm_paper_8a_blocks1and2_not_consecutive(self):
        ...
        nxt_gate = find_consecutive_gate(
            partitioned_gates, (instr.INSTR_CNOT, 2, "node_0", 2, "node_1"), 1
        )
    ...
    def test_identifies_different_cnots_as_consecutive(self):
        ...
        nxt_gate = find_consecutive_gate(partitioned_gates, gate0, 0)
...
class Test_find_consecutive_remote_gates(unittest.TestCase):
    def test_gets_same_result_as_autocomm_paper8a(self):
        ...
        partitioned_gates = produce_partitioned_circuit_from_fig4_in_autocomm_paper()
        # the remote gates associated with the qubit-node pair that has the most
        # remote gates:
        filtered_remote_gates = [
            ((instr.INSTR_CNOT, 2, "node_0", 2, "node_1"), 1),
        ...
        burst_comm_blocks = find_consecutive_remote_gates(
            partitioned_gates, filtered_remote_gates
        )
