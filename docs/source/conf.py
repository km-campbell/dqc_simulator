...
sys.path.insert(0, os.path.abspath("../../src/dqc_simulator/"))


# -- Project information -----------------------------------------------------

project = "dqc_simulator"
copyright = "2024, Kenny Campbell"
...
todo_include_todos = True  # allows todo and todolist ot produce output
